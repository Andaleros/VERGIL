...
global.waterMark = "NOW I FEEL MOTIVATED" // Your own watermark 
global.headerText = "VERGIL by MrGatto" // text for header of menu         
global.DocumentTitle = "ANDALEROS" 


global.ownername = "Andaleros"   // Owner name //        
...
global.mess = {
    ...
    ban: 'MALEDETTO sei stato bannato da me ovvero Andaleros😡, se vuoi essere sbannato contattami.',
    nsfw: 'AO GUARDA ER PERVERTITO👏, no dai scherzo la funzione non è attiva',
    banChat: 'Il bot è bannato da questo gruppo!, contatta il proprietario su telegram o fatti il bot da solo maledetto.'
}

//--------------- Menu images ----------------\\
global.Menuimage = fs.readFileSync("./AnyaPikaMedia/theme/Menu/EQ6DosXUcAAvIKU.jpg_large.jpg)
